...
var app = {
    ...
    onDeviceReady: function () {
        ...
        $("#btnFicarOnline").click(function () {
            console.log('btn ficar online clicado');
            //Add Token Here
        ...
        $("#btnFicarOffline").click(function () {
                console.log('btnFicarOffline');
               app.set_status("OFFLINE");
        });

        $("#btnVerEntregas").click(function () {
            console.log('btnVerEntregas');
    ...
    console.log('set Statussss');
        ...
        console.log('set Statussss2');
        var url =  this.get_api_path() + `/externo/api/ws/Alocaja/set_status_motorista`;
        console.log('set Statussss3');
        var fgGeo = window.navigator.geolocation;
        console.log('111 getCurrentPosition', JSON.stringify(window.navigator));
        console.log('222 window.navigator', JSON.stringify(navigator));
        console.log('333 getCurrentPosition', JSON.stringify(window.navigator.geolocation));

        var legal = window.navigator.geolocation.getCurrentPosition(app.onSuccess, app.onError);

        console.log('set Statussss4');
        var coords;
        console.log('antes getCurrentPosition', JSON.stringify(window.navigator));
