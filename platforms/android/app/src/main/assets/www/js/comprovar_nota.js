    ...
    loadCheckinData: function(){
        ...
        if(checkin_nota != null)
            if(checkin_nota != null)
            {
                ...
                $("#obs").text(checkin_nota.observacao);
                if (checkin_nota.observacao != '') {
                    $("#div_obs").fadeIn(50);
                }
            }
...
//                while (i < imgs.length){
            ...
            window.getPicture = function () {
                ...
                function onSuccess(imageData) {
                   window.resolveLocalFileSystemURL(imageData.url, function(fileEntry) {
...
//                                  img.src = base64Data; // Exibe a imagem convertida em base64
                                  console.log('base64', base64Data)
                                  app.addImage(base64Data);
                              };
                          ...
                          console.log("Erro ao resolver URL do arquivo: " + err);
                      });
                }
