...
var app = {
 ...
 var mapOptions = {
        ...
        $(document).ready(function () {
           ...
           app.pickLocation(transporte.endereco_centro, true)
            ...
            screen.orientation.lock('portrait');
                ...
                $("#codigo").html(transporte.transporte_id);
                $("#centro").html(transporte.centro);
                $("#preco").html((transporte.preco/100).toLocaleString('pt-br', {minimumFractionDigits: 2}));
                ...
                $("#btnIniciarTransporte").click(function () {
                    navigator.notification.confirm('Você se compromete a coletar e entregar as notas listadas?',
                        function (e) {
                            if (e == 1) {
                                var transporte =  JSON.parse(window.localStorage.getItem("transporte"));
                        ...
                        }, 'Confirmar Aceite do Transporte', 'SIM,Cancelar');
                })
  ...
  console.log(address)
  var loca;
  console.log("ENDERECO SAO BERNADO");
  console.log(address)
   ...
   app.map.fitBounds(bounds);
    ...
    console.log("iniciar_transporte_agendado")
        ...
        let success = function (msg) {
            ...
            console.log(msg);
            if (msg.success == 'true') {
                navigator.notification.alert("Transporte alocado com sucesso!", null, "Sucesso!", 'OK');
                ...
                window.location = 'tela_historico_aguardando_alocaja.html';
            }else{
        ...
        formData.append('motorista',  window.localStorage.getItem("login"));
        ...
        webservice_access.iniciar_transporte_dinamico(formData, beforeSend, success, error);
