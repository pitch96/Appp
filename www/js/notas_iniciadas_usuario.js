        ...
        console.log(document.notas);
         $.each(document.notas, function (i, item) {
             ...
             if(item.is_cache != null && item.is_cache){
                 row = '<li id="' + i + '" onclick="document.onClickGrid(this);" class="list-item with-second-label with-icon bg-red-50">' +
                     '<div class="row"><div class="cell"><span  class="fa-2x fa fa-save fg-purple-300"></span></div>' +
                     '<div class="cell"><span class="label" id="nota">NF-E/O.S: ' + item.nfe + '-' + item.serie  + ' (Envio Pendente)</span>' +
                     '<span class="second-label" id="data_hora">Data e Hora: ' + data_checkin + '</span>' +
                     '<span class="second-label" id="data_hora">Dados em Cache</span></div></li>';
             }else{
                 row =
                     '<li id="' + i + '" onclick="document.onClickGrid(this);"  class="list-item with-second-label ' +(i % 2 ? 'bg-gray-50' : '' ) + '">' +
                     '<div class="row"><div class="cell"><span  class="fa-2x fa fa-truck-moving fg-purple-300"></span></div>' +
                     '<div class="cell"><span class="label" id="nota">NF-E/O.S: ' + item.num_nfe + '-' + item.serie_nfe  + '</span>' +
                     '<span class="second-label" id="data_hora">Data e Hora: ' + data_checkin + '</span>' +
                     '<span class="second-label" id="data_hora">Checkin Iniciado</span></div></li>';
             }
